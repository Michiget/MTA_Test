...
public class AnsiLog {
	...
	public static void bb(int len) {
		String blk = ""; for(int i=0;i<len;i++) blk += " ";
		System.out.println(ansi().bg(WHITE).fg(BLUE).bold().newline().a(blk).reset());
	}

	public static void eb(int len) {
		String blk = ""; for(int i=0;i<len;i++) blk += " ";
		System.out.println(ansi().bg(WHITE).fg(BLUE).bold().a(blk).newline().reset());
	}
	
	public static void b(String s, int mw) {
		while(s.length() < mw)
			s += " ";
		System.out.println(ansi().bg(WHITE).fg(BLUE).bold().a(s).reset());
		logger.info(s);
	}
	...
	public static void i4(String s) {
		String msg = String.format("[INFO4-0000] %s", s);
		System.out.println(ansi().bg(WHITE).fg(BLUE).bold().a(getNow()+msg).reset());
		logger.info(msg);
	}
	
	public static void i4(int c, String s) {
		String msg = String.format("[INFO4-%04d] %s", c, s);
		System.out.println(ansi().bg(WHITE).fg(BLUE).bold().a(getNow()+msg).reset());
		logger.info(msg);
	}
	
	public static void i5(String s) {
		String msg = String.format("[INFO5-0000] %s", s);
		System.out.println(ansi().fg(YELLOW).bold().a(getNow()+msg).reset());
		logger.info(msg);
	}
	
	public static void i5(int c, String s) {
		String msg = String.format("[INFO5-%04d] %s", c, s);
		System.out.println(ansi().fg(YELLOW).bold().a(getNow()+msg).reset());
		logger.info(msg);
	}
	
	public static void i6(String s) {
		String msg = String.format("[INFO6-0000] %s", s);
		System.out.println(ansi().fg(MAGENTA).bold().a(getNow()+msg).reset());
		logger.info(msg);
	}
	
	public static void i6(int c, String s) {
		String msg = String.format("[INFO6-%04d] %s", c, s);
		System.out.println(ansi().fg(MAGENTA).bold().a(getNow()+msg).reset());
		logger.info(msg);
	}
