...
public class Window {
	...
	public String toString() {
		...
		str += ", name=" + name+ ", serial=" + serial + ", model=" + model;
		str += ", sensor=" + sensor+ ", isInputRotation=" + isInputRotation+ ", rotation=" + rotation;
		str += ", density=" + density+ ", dpiX=" + dpiX + ", dpiY=" + dpiY;
		str += ", physicalWidth=" + physicalWidth + ", physicalHeight=" + physicalHeight;
		str += ", currentWidth=" + currentWidth + ", currentHeight=" + currentHeight;
		str += ", appWidth=" + appWidth + ", appHeight=" + appHeight;
		str += ", virtualWidth=" + virtualWidth + ", virtualHeight=" + virtualHeight;
		str += ", battery=" + battery + ", memory(kb)=" + memory;
		str += ", isWifi=" + isWifi + ", wifiAP=" + wifiAP;
		str += "]";
