...
public class SendKeyScript extends AbstractRemoteCommand {

	public SendKeyScript(CommandServer.ConnectionCommandWrap wrap) {
		super(wrap);
	}
	...
	public JSONObject respond(JSONObject args) throws IOException, JSONException {
		...
		if(args.has("keycode") || args.has("keys") || args.has("text")) {
			action();
		}
		else 
