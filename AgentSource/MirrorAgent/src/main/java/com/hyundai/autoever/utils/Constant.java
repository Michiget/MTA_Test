...
public class Constant {
	...
	public static final String MIRROR_DATE = "20171212";
	public static final String MIRROR_DIR = "mirror" + MIRROR_DATE;
	public static final String MIRROR_VER = MIRROR_DATE + ".ver";
	public static final String MIRROR_BIN = "bin";
	public static final String MIRROR_SO = "so";
	
	public static final String MIRROR_KEY = "ABFBF265FFDEAB44";
	
	public static File getMrrorZip() {
		return new File(ROOT, "mirror.zip");
	}
	
	public static File getMrrorTestZip() {
		return new File(ROOT, "mirrortest.zip");
	}
	
	public static File getMrrorDat() {
		return new File(ROOT, "mirror.dat");
	}
	
	public static File getMrrorTmpZip() {
		String tmpFile = MIRROR_DIR + File.separator + "mirror" + MIRROR_DATE + ".dat";
		return new File(TMP, tmpFile);
	}

	public static File getTmpDir() {
		return new File(TMP, MIRROR_DIR);
	}

	public static File getTmpBinDir(String abi) {
		String dir = TMP + File.separator + MIRROR_DIR + File.separator + abi;
		File dFile = new File(dir);
		dFile.mkdirs();
		return dFile;
	}

	public static File getTmpSoDir(String abi, String sdk) {
		String dir = TMP + File.separator + MIRROR_DIR + File.separator + "android-" + sdk + File.separator + abi;
		File dFile = new File(dir);
		dFile.mkdirs();
		return dFile;
	}
	...
	public static File getTmpFile(String name) {
		return new File(TMP, MIRROR_DIR + File.separator + name);
	}
	
	public static File getTmpBinFile(String name, String abi) {
		File dFile = getTmpBinDir(abi);
		return new File(dFile, name);
	}
	
	public static File getTmpSoFile(String name, String abi, String sdk) {
		File dFile = getTmpSoDir(abi, sdk);
		return new File(dFile, name);
	}

	public static String getADBPlatformTools() {
		return ROOT + File.separator + "platform-tools";
	}
